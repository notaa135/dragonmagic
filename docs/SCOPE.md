...
- Three actual prototype runtime screenshots.
...
All images are unchanged copies of the later rescue worktree's May 18, 2026 Godot runtime captures:
...
Later static UI mockups and motion studies are not presented as implemented gameplay.
